...
INSERT INTO auth.users (user_id, email, password_hash, role, status, created_at, updated_at)
VALUES (gen_random_uuid(), 'herbert.abingwa@njinkofarm.com', crypt('Temp#123', gen_salt('bf', 12)), 'regulator', 'reset_required', NOW(), NOW());
