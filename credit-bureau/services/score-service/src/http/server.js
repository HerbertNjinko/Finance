...
import { getScoreHandler, recalcScoreHandler } from '../controllers/scoreController.js';

const routes = [
  { method: 'GET', pattern: /^\/v1\/scores\/([0-9a-fA-F-]{36})$/, handler: getScoreHandler },
  { method: 'POST', pattern: /^\/v1\/scores\/recalculate$/, handler: recalcScoreHandler }
];
